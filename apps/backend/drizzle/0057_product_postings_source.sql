...
-- sit in the review queue until a user merges it onto a master — merging is
-- always a human decision (PRD 17.4 precedent in marketplace_sku_map: never
-- auto-link, only ever suggest).
DO $$ BEGIN
