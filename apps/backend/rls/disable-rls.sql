...
BEGIN
  FOREACH t IN ARRAY ARRAY[
    ...
    'payout_disbursements','product_costing','materials','material_purchases','material_purchase_items','password_reset_tokens','resi_scans','packing_settings','shop_categories'
  ] LOOP
